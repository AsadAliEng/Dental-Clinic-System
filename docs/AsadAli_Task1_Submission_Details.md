...
1. Upload `AsadAli_Task1_Report.pdf` and `AsadAli_Task1_Submission_Details.md` to Google Drive.
2. Set **General access Ã¢â€ â€™ Anyone with the link Ã¢â€ â€™ Viewer**.
3. Copy both public links into the two placeholders above and the submission form.
